"""
Enhanced Hybrid GitHub Assistant with AI-powered QueryRouter.
...
# Configure logging to suppress verbose third-party messages
...
class EnhancedGitHubAssistant:
    ...
    async def initialize(self):
        ...
        print("Initializing Enhanced GitHub Assistant...")
...
"""
    ...
    def _simple_routing(self, query: str) -> RoutingDecision:
        ...
        from query_router import RoutingDecision, QueryType
...
# Demo function
async def demo_enhanced_assistant():
    """Demonstrate the enhanced assistant capabilities."""
    
    assistant = EnhancedGitHubAssistant()
    ...
    print("\n" + "="*70)
    print("ENHANCED HYBRID ASSISTANT DEMO")
    print("="*70)
    ...
    print(f"\nEnhanced assistant demo completed!")
    print(f"Status: {assistant.get_status()}")


if __name__ == "__main__":
    asyncio.run(demo_enhanced_assistant())
